...
| **合计（8 场，本金 $80,000）** | | | | | **+18,639** |

> ⚠️ 诚实提示：仅 8 场样本，收益高度集中于卡塔尔–瑞士一场平局冷门（@8.00，+$10,800，约占六成）；
> 对着庄家约 5.9% 的水位，该策略整体期望为负。这是运气，**不是**跑赢市场的证据——而这恰恰是本
> 项目反复强调的一点，完整论证见 [`docs/FINDINGS.md`](docs/FINDINGS.md)。
